...
function showComentarios(comentarios) {
    ...
    for (let comentario of comentarios) {
        container.innerHTML += `<li class='list-group-item d-flex justify-content-between'> 
        <span class="usuario"> ${comentario.email} </span>  
        ${comentario.texto} - 
        <span class="calificacion">  ${comentario.calificacion} 
        ...
        <button class="eliminar btn btn-danger" data-id="${comentario.id}" >ELIMINAR</button> </li>`;
    }
