    ...
    <table class="table ">
        ...
        {foreach from=$regiones item= $region}
            <tr>
                ...
                <td><a class='btn btn-danger btn-sm' href='actualizarRegion/{$region->id}'><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
